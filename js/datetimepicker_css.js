...
var TodayColor="pink";//Background color of today.
var SelDateColor="blue";//Backgrond color of selected date in textbox.
...
function NewCssCal(pCtrl,pFormat,pScroller,pHideShowTime,pHideTimeMode,pHideSeconds) {
	...
	if ((pShowTime=null) && (pShowTime)) {
        ...
        {
            if (pHideSeconds)
            {Cal.HideShowSeconds=false;}
            else
            {Cal.HideShowSeconds=true;}
  ...
  //******************End Month and Year selector in arrow******************************
	...
	if (winCal == undefined) {
     ...
     // add javascript function to the span cal
       ...
       with (span.style) {position = "absolute"; left = (xpos+8)+'px'; top = (ypos-8)+'px'; width = CalWidth+'px'; border = "solid 2pt " + SpanBorderColor; padding = "0pt"; cursor = "move"; backgroundColor = SpanBgColor; zIndex = 2000;}
